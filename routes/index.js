...
router.get('/api/v1/get-author', authorController.findAuthors);
...
router.get('/api/v1/get-comment', commentController.findComments);
...
router.put('/api/v1/change-category/:id', categoryController.changeCategory);
